...
class AgentConfig:
    ...
    def __init__(self,
                 epsilon_start=1.,
                 epsilon_final=0.01,
                 epsilon_decay=600,  # Vorschlag T.Iten 800. Original Wert 8000
                 gamma=0.99,
                 lr=1e-4,
                 target_net_update_freq=300,  # Vorschlag T.Iten 300. Original Wert 1000
                 memory_size=100000,
                 batch_size=128,
                 learning_starts=5000,
                 max_frames=600000,  # Original Wert 10_000 _000
                 tau=0.25):  # Vorschlag T.Iten 0.3
